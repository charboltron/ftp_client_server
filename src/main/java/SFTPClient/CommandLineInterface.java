                ...
                if (!ourConnection.isConnected()){
                    ...
                    while(true){
                        ...
                        try{
                            ...
                            System.err.println(shit.getMessage()); //lol this variable is still named this
                            System.err.println("Something went wrong, see the message above. Please try another command.");
                        }
                        setCommand();
                    }
                    break;
